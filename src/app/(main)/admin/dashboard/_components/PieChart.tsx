...
export default function DashboardPieChart({
  ...
  if (!data || data.length === 0) {
    return (
      <div className="flex h-65 items-center justify-center text-xs text-slate-400 font-medium">
          ...
          return (
            ...
            >
              <div className="flex items-center gap-2.5 min-w-0">
                ...
                <HeroTooltip delay={0}>
                  <HeroTooltip.Trigger>
                    <span className="text-xs font-medium text-gray-600 truncate max-w-40 md:max-w-50 block cursor-help">
                      {entry.name}
                    </span>
                  </HeroTooltip.Trigger>
                  <HeroTooltip.Content showArrow>
                    <HeroTooltip.Arrow />
                    <div className="px-1 py-1 text-xs text-gray-700 ">
              ...
              <span className="text-xs text-gray-800 ml-2 font-bold shrink-0">
                {percentage}%
              </span>
            </div>
          );
