      ...
      <header className="mb-8 flex items-end justify-between">
        <div>
          ...
          <p className="text-slate-500 mt-0 ml-3">
            ...
            {currentTw ? (
              <span className="font-semibold text-blue-600">{TW_LABELS[currentTw]}</span>
            ) : ""}.
          </p>
        </div>
      </header>
              ...
              <div className="space-y-6">
                {recentActivities.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-6 text-center">
                    ...
                    <p className="text-slate-400 text-sm">Belum ada aktivitas dilaporkan.</p>
                  </div>
                ) : (
                  recentActivities.map((act: any, index: number) => (
                    <div key={act.id} className="relative pl-8">
                      ...
                      {index !== recentActivities.length - 1 && (
                        <div className="absolute left-[11px] top-7 bottom-[-24px] w-0.5 bg-slate-100 rounded-full" />
                      )}
                      ...
                      <div className="flex flex-col min-w-0 pt-0.5 group">
                        ...
                        <p className="text-xs text-slate-500 mt-0.5 flex items-center gap-2">
                          ...
                          <span
                            className={`capitalize font-medium tracking-wide text-[10px] uppercase ${act.status === "APPROVED" ? "text-emerald-600" : act.status === "REJECTED" ? "text-red-600" : "text-amber-600"}`}
                          >
              ...
              <div className="space-y-2">
                {leaderboard.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-8 text-center">
                    ...
                    <p className="text-slate-400 text-sm">Belum ada data peringkat.</p>
                  </div>
                ) : (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="text-sm font-semibold text-slate-900 flex items-center gap-2 min-w-0">
                          ...
                          {pic.isMe && (
                            <Chip size="sm" className="h-4 bg-blue-100 px-1 shrink-0">
